...
const contacts = [
  {
    icon: <TelegramIcon />,
    label: "Telegram",
    value: "t.me/portmirage",
    href: "https://t.me/portmirage",
  },
  {
    icon: <InstagramIcon />,
    label: "Instagram",
    value: "instagram.com/portmirage",
    href: "https://www.instagram.com/portmirage",
  },
  {
    icon: <YouTubeIcon />,
    label: "YouTube",
    value: "youtube.com/@portmirage",
    href: "https://youtube.com/@portmirage",
  },
  {
    icon: <SoundCloudIcon />,
    label: "SoundCloud",
    value: "soundcloud.com/port-mirage",
  ...
  },
  {
    ...
    label: "Email",
    value: "portmirage@gmail.com",
    href: "mailto:portmirage@gmail.com",
  },
];
...
export default function ContactsSection() {
  return (
    <section id="contacts" className="py-20 md:py-32 bg-[#1a1a1a] relative overflow-hidden">
      ...
      <footer className="mt-16 border-t border-white/6 pt-8 text-center relative z-10">
