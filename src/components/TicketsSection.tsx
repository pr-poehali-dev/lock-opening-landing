  ...
  return (
    <section id="tickets" className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <span className="inline-flex items-center gap-2 mb-6 px-4 py-2 border border-brand-red/50 rounded-full bg-brand-red/10 backdrop-blur-sm">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <div className="px-6 py-3 bg-white/5 border border-white/10 rounded-lg backdrop-blur-sm">
            <div className="font-orbitron text-xs text-gray-400 uppercase tracking-widest">Ранние птички</div>
            <div className="font-orbitron text-2xl font-bold text-white mt-1">1 500 ₽</div>
            <div className="font-rajdhani text-xs text-brand-red mt-1 uppercase tracking-wide">Осталось 12 шт</div>
          </div>
          <div className="px-6 py-3 bg-brand-red/10 border border-brand-red/40 rounded-lg backdrop-blur-sm glow-border-red">
            ...
            <div className="font-rajdhani text-xs text-green-400 mt-1 uppercase tracking-wide">Доступно</div>
          </div>
          <div className="px-6 py-3 bg-white/5 border border-white/10 rounded-lg backdrop-blur-sm">
            <div className="font-orbitron text-xs text-gray-400 uppercase tracking-widest">VIP</div>
        ...
        <a
          href="#"
          className="inline-block px-12 py-5 bg-brand-red text-white font-orbitron font-black text-base tracking-widest uppercase rounded-lg hover:bg-brand-red-dark transition-all duration-300 animate-pulse-red shadow-2xl shadow-brand-red/40"
        >
          Купить билет →
        </a>
