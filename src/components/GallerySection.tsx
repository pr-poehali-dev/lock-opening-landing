...
export default function GallerySection() {
  ...
  return (
    <section id="gallery" className="py-20 md:py-32 bg-dark-graphite relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="font-orbitron text-3xl sm:text-4xl md:text-5xl font-bold text-white mt-3">
            Гале<span className="text-gradient-red">рея</span>
          </h2>
          ...
          {mediaItems.map((item, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                {item.type === "video" ? (
                  <div className="w-14 h-14 rounded-full bg-brand-red/90 flex items-center justify-center shadow-lg">
              ...
              {item.type === "video" && (
                <div className="absolute top-3 left-3 flex items-center gap-1.5 bg-brand-red/90 px-2.5 py-1 rounded-full">
